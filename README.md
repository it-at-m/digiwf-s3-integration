...
_For more examples, please refer to the [Examples](https://github.com/it-at-m/digiwf-s3-integration/tree/{{ current.branch }}/example-s3-integration)
folder_
...
_For more examples, please refer to the [Examples](https://github.com/it-at-m/digiwf-s3-integration/tree/{{ current.branch }}/example-s3-integration-client)
folder_
